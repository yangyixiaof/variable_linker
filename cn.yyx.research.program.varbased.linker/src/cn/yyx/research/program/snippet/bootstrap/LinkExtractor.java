...
import cn.yyx.research.program.ir.visual.dot.generation.IRGraphDotGenerator;
	...
	public Object start(IApplicationContext context) throws Exception {
		...
		try {
			...
			if (IRControlMeta.test) {
				...
				IRGraphDotGenerator irproj_local_generation = new IRGraphDotGenerator(DotMeta.ProjectEachMethodDotDir, DotMeta.ProjectEachMethodPicDir, graph_manager);
				...
				IRGraphDotGenerator irproj_global_generation = new IRGraphDotGenerator(DotMeta.ProjectFullTraceDotDir, DotMeta.ProjectFullTracePicDir, graph_manager);
