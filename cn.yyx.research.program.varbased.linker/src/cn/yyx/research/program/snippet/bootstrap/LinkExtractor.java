...
import cn.yyx.research.program.ir.visual.dot.generation.IRGraphGenerateDot;
	...
	public Object start(IApplicationContext context) throws Exception {
		...
		try {
			...
			if (IRControlMeta.test) {
				...
				IRGraphGenerateDot irproj_local_generation = new IRGraphGenerateDot(DotMeta.ProjectEachMethodDotDir, DotMeta.ProjectEachMethodPicDir, graph_manager);
				...
				IRGraphGenerateDot irproj_global_generation = new IRGraphGenerateDot(DotMeta.ProjectFullTraceDotDir, DotMeta.ProjectFullTracePicDir, graph_manager);
